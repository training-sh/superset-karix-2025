we assume that we have files in /root/tpch_csv

open second ssh to your vm..

this is to login into mysql vm
...
docker exec -i superset_mysql mysql -uroot -pmysql_root_pass -e "
